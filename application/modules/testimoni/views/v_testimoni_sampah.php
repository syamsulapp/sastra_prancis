<div class="row">
	<div class="col-lg-12">
		<form action="<?php echo site_url();?>testimoni/deltestimonimassalpermanen" name="form_hapus_tulisan_massal" id="form-hapus-tulisan-massal" method="post">
		<ul class="uk-tab">
				...
				<div style="float:right" class="row col-md-4">
					<div class="input-group">
					  ...
					  <div class="input-group-btn">
					    ...
					    <a href="<?php echo site_url().'testimoni/sampah';?>" class="btn btn-default"><i class="fa fa-refresh"></i></a>
					  </div>
					</div>
				</div>
				<br />
		...
		<table class="uk-table">
			...
			?>
				<tr id="tmp_tr_<?php echo$row['id_testimoni'];?>">
					<td>
					...
					<td id="tmp_smb_<?php echo$row['id_testimoni'];?>">
						<a href="#" title="Kembalikan" onclick="set_kembalikan('<?php echo$row['id_testimoni']?>')" class="text-primary">
					...
					<td><a href="#" title="Ubah" onclick="set_delete({
							...
							,act:'<?php echo site_url();?>testimoni/deltestimonipermanen'
...
function set_kembalikan(id){
	$.ajax({
        'url': '<?php echo site_url("testimoni/kembalikan/'+id+'")?>',
        'dataType': 'json',
...
function cari(val){
	window.location.assign("<?php echo site_url()?>testimoni/sampah?cari="+val)
}
</script>
