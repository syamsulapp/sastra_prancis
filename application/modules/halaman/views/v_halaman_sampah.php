<div class="row">
	<div class="col-lg-12">
		<form action="<?php echo site_url();?>halaman/delhalamanmassalpermanen" name="form_hapus_tulisan_massal" id="form-hapus-tulisan-massal" method="post">
		<ul class="uk-tab">
            <li class=""><a href="<?php echo site_url()?>halaman">Semua (<?php if(@$data['total_rows_2'][0]['total']){echo$data['total_rows_2'][0]['total'];}else{echo'0';}?>)</a></li>
				...
				<div style="float:right" class="row col-md-4">
					<div class="input-group">
					  ...
					  <div class="input-group-btn">
					    ...
					    <a href="<?php echo site_url().'halaman/sampah';?>" class="btn btn-default"><i class="fa fa-refresh"></i></a>
					  </div>
					</div>
				</div>
				<br />
				...
				?>
					<tr id="tmp_tr_<?php echo$row['id_tulisan'];?>">
						...
						<td><a href="#" title="Ubah" onclick="set_delete({
								...
								,act:'<?php echo site_url();?>halaman/delhalamanpermanen'
		...
		<div class="block" style="margin-top:10px;">
			<div class="form-group">
				...
				<div style="float:right">
					<i><gedank id="jml-list-bawah"><?php if(@$data['total_rows'])echo$data['total_rows'];?></gedank> halaman</i>
				</div>
			</div>
		</div>
		</form>
				...
				<div class="col-lg-12">
					<form id="form_action_del" action="" method="post">
						<div class="modal-header">
							...
							<h3 id="modal_title" class="modal-title">Hapus halaman</h3>
						</div>
...
function set_kembalikan(id){
	$.ajax({
        'url': '<?php echo site_url("halaman/kembalikan/'+id+'")?>',
        'dataType': 'json',
...
function cari(val){
	window.location.assign("<?php echo site_url()?>halaman/sampah?cari="+val)
}
</script>
