...
<div class="row">
	...
	<div class="col-lg-4">
		<form action="<?php echo site_url() ?>video/addvideo" name="form_tambah_video" id="form-tambah-video" method="post">
			...
			<!-- <div class="form-group">
				<button type="reset" class="md-btn md-btn-default square-btn-adjust" title="Batal/Reset Form" onclick="form_tambah_video_reset()">
					<li class="fa fa-times"></li> Batal
				</button>
				<button type="submit" class="md-btn md-btn-primary square-btn-adjust" title="Tambah video baru">
					<li class="fa fa-save"></li> Tambah Video Baru
				</button>
			</div> -->
		</form>
	</div>
			...
			<div class="block" style="margin-top:10px;">
				<div class="form-group">
					...
					<div style="float:right">
						<i>
							<gedank id="jml-list-bawah"><?php if (@$data['total_rows']) echo $data['total_rows']; ?></gedank> video
						</i>
					</div>
				</div>
			</div>
