...
class Crud
{
	...
	function get($table_name, $where = array(), $rule = array(), $join = array(), $select = null, $string = null)
	{
		return $this->ci->crud_model->get($table_name, $where, $rule, $join, $select, $string);
	}

	function get_header($table_name)
	{
		return $this->ci->crud_model->get_header($table_name);
	}
